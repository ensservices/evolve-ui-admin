        ...
        <Menu as="div" className="relative inline-block text-left">
          <div>
            <Menu.Button className="inline-flex w-full justify-center items-center">
              ...
              <span className="hidden md:block font-medium text-danger">
                Account
              </span>
            ...
            <Menu.Items className="absolute right-0 w-56 z-50 mt-2 origin-top-right bg-white rounded shadow-sm">
              <div className="p-1">
                <Menu.Item>
                  <Link
                    href="/add_user"
                    className="flex hover:bg-orange-100 hover:text-white text-danger rounded p-2 text-sm group transition-colors items-center"
                  >
                    <b>
                      Add User
                    </b>
